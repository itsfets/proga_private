...
public class StandardBuilder implements BuilderTemplate<StudyGroup> {
    private int id;
    private String name;
    ...
    @Override
    public StudyGroup build(ValidatorTemplate<StudyGroup> validator, int id) {
    ...
    public StudyGroup buildRaw(int id) {
        ...
        if (hasGroupAdmin) {
            new Person(groupAdmin_name, groupAdmin_height, groupAdmin_color,
            new Location(groupAdmin_location_x, groupAdmin_location_y, groupAdmin_location_z, groupAdmin_location_name));
            return new StudyGroup(id, name, coordinates, studentsCount,transferredStudents, averageMark, formOfEducation,
                    new Person(groupAdmin_name, groupAdmin_height, groupAdmin_color, new Location(groupAdmin_location_x, groupAdmin_location_y, groupAdmin_location_z, groupAdmin_location_name)));
        }
