...
public class Asker {
    ...
    public StudyGroup askStudyGroup(StudyGroupValidator validator, int id) {
        ...
        ask.askThing("Has groupAdmin? (true if Yes, any other response is treated as No): ", builder, StandardBuilder::hasGroupAdmin, Boolean::valueOf, StandardConfig.HAS_GROUP_ADMIN);
